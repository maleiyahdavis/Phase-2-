...
---------------------------------------------------------------------------------------
select region_name as "region with most locations"
from regions 
where region_id = 1; 
...
select products.product_name, products.list_price, category_name 
...
select distinct product_name, products.list_price
from warehouses 
join inventories
